...
<!-- ================= TAMPILKAN SEMUA ================= -->
<section class="max-w-[1320px] mx-auto px-6 text-center mb-12">
    <button class="px-6 py-2 bg-[#F59A40]/20 text-[#F59A40] text-sm font-medium rounded-full">
        Tampilkan semua
    </button>
</section>


<!-- ================= SECTION MASKOT + CONTENT ================= -->
<section class="max-w-[1320px] mx-auto px-6 mb-24">
    ...
    <div class="grid md:grid-cols-3 gap-8 items-center">
        ...
        <!-- Box Besar 1 -->
        <div class="md:col-span-1 h-[280px] bg-white border rounded-3xl"></div>
...
<section class="max-w-[1320px] mx-auto px-6 mb-24">
    ...
    <div class="grid md:grid-cols-4 gap-6">
        ...
        <div class="bg-white border rounded-2xl p-4">
            ...
            <!-- Button -->
            <div class="mt-4 flex justify-end">
<button class="px-4 py-1 border border-[#F59A40]
               text-[#F59A40] rounded-full
