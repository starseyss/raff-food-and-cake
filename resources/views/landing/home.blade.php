...
<div class="product-card block bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-4
...
<!-- ================= TAMPILKAN SEMUA ================= -->
<section class="max-w-[1320px] mx-auto px-6 text-center mb-12 flex justify-center gap-4">
    <button id="showLessBtn" class="px-6 py-2 bg-gray-200 text-gray-600 text-sm font-medium rounded-full hover:bg-gray-300 transition hidden">
        Tampilkan sedikitkan
    </button>
    <button id="loadMoreBtn" class="px-6 py-2 bg-[#F59A40]/20 text-[#F59A40] text-sm font-medium rounded-full hover:bg-[#F59A40] hover:text-white transition {{ $produk->count() <= 12 ? 'hidden' : '' }}">
        ...
        <div class="md:col-span-8">
            <div class="relative select-none">
                ...
                <div id="promoContainer"
                     class="relative overflow-hidden rounded-[30px] aspect-[16/9] cursor-grab active:cursor-grabbing">
                    ...
                    <div id="promoSlider"
                        ...
                        <div class="min-w-full bg-[#F59A40] flex items-center justify-center">
                            <div class="text-center px-6">
                                <h2 class="text-white text-3xl font-bold">Diskon 20% Semua Cake 🎂</h2>
                                <p class="text-white/90 mt-2">Nikmati promo spesial hari ini</p>
                            </div>
                        </div>
                        ...
                        <div class="min-w-full bg-orange-500 flex items-center justify-center">
                            <div class="text-center px-6">
                                <h2 class="text-white text-3xl font-bold">Paket Catering Hemat 🍱</h2>
                                <p class="text-white/90 mt-2">Cocok untuk acara keluarga</p>
                            </div>
                        </div>
                        ...
                        <div class="min-w-full bg-orange-600 flex items-center justify-center">
                            <div class="text-center px-6">
                                <h2 class="text-white text-3xl font-bold">Gratis Ongkir 🚚</h2>
                                <p class="text-white/90 mt-2">Minimal belanja 100rb</p>
                            </div>
                        </div>
                        ...
                        <div class="min-w-full bg-orange-700 flex items-center justify-center">
                            <div class="text-center px-6">
                                <h2 class="text-white text-3xl font-bold">Menu Favorit 🔥</h2>
                                <p class="text-white/90 mt-2">Pilihan terbaik hari ini</p>
                            </div>
                        </div>
                ...
                <div class="mt-4 flex flex-col items-center gap-3">
                    ...
                    <div class="flex items-center gap-4">
                        <button onclick="prevPromo()"
                            class="w-10 h-10 rounded-full bg-white text-[#F59A40]
                                   shadow border border-gray-100 flex items-center justify-center
                                   hover:bg-[#F59A40] hover:text-white transition">
                            ←
                        </button>
                    ...
                    <div id="promoDots" class="flex items-center gap-2">
                        <button onclick="goToPromo(0)"
                            class="w-3 h-3 rounded-full bg-[#F59A40] transition"></button>
                        <button onclick="goToPromo(1)"
                            class="w-3 h-3 rounded-full bg-gray-300 transition"></button>
